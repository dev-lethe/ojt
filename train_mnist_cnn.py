...
def main():
    parser = argparse.ArgumentParser(description='PyTorch example: MNIST with CNN')
    ...
    parser.add_argument('--out', '-o', default='result/mnist_cnn/',
    ...
    model = MNIST_CNN(n_in=1, n_out=10)
    ...
    # Save weights
    torch.save(model.state_dict(), os.path.join(args.out, 'model.ckpt'))
